 ...
 */
//DONE JAVADOC AND CODING FOR PRESENTATION
import java.util.*;
import java.io.*;
...
public class DJ{
    ...
    //instance methods
    /**
     * This method will print all of the songs in the Playlist out to an txt file which
     * will eventually be displayed on the WZLY website. 
     */
    public void  printLatestPlaylist(){
